...
BEGIN {
    print "<html><head><title>Public Building Permit Records</title></head><body>" > "output.html"
    print "<h1>Public Building Permit Records</h1>" > "output.html"
    print "<table border=1>" > "output.html"
    print "<tr><th>Andrew Gerber</th>></tr>" > "output.html"
    print "<tr><th>Date</th><th>Subdivision</th><th>Lot #</th><th>Block #</th><th>Value $</th></tr>" > "output.html"
...
#check if the description is a single family home
{
    ...
    # print $3
    print "<tr><td>" $1 "</td><td>" $5 "</td><td>" $6 "</td><td>" $7 "</td><td>" $8 "</td></tr>" > "output.html"
    }
}

END {
    print "</table>" > "output.html"
    print "</body></html>" > "output.html"
}